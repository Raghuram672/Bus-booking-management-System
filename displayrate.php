...
?>
    ...
    <div class="output">
        ...
        <tr class="tablehead">
          ...
          <th scope="col">Rate in Rs.per kilometers</th>
...
if($result){
  ...
  <td><button ><a href="updatebus.php?updateid='.$id.'" >update</a></button></td>
...
?>
    ...
    <div>
        <button >
            <a href="Buscharge.php">Add bus</a>
        </button>
    </div>
</body>
</html>